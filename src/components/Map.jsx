...
const Map = ({setCoordinates, setBounds, coordinates,places,isMapLoading}) => {
  ...
  return (
  <section className=" md:col-span-8 w-full h-[50vh] md:h-full p-4 bg-gradient-to-r"   style={{"background": "black"}} >
      ...
      </GoogleMapReact>:<div ><h1 className="lg:hidden text-xl font-bold text-center">Turn On Your GPS and Refresh to Get Best Places Near You</h1><div className="hidden md:block mt-12"><Spinner /><h1 className="hidden lg:block text-center font-bold mt-6 text-2xl">Click Allow to Get Best Places Near You</h1></div></div>}
